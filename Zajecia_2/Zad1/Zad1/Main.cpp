...
void RenderScene(void)
{
	...
	GLfloat curSize; // Zapamêtuje aktualny rozmiar
	...
	curSize = sizes[0];
	// Ustalenie pocz¹tkowej wspó³rzêdnej z
	x = -50.0f;
	// Obracamy siê w kó³ko 14 razy
	for (angle = 0; angle <= (2.0f*3.1415f)*14.0f; angle += 0.3f)
	{
