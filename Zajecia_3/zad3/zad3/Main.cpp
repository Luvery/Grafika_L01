...
void GenerateTextures()
{
	...
	// wczytanie tekstury JUPITER utworzonej ze zdjęć sondy Magellan
	// plik: http://maps.jpl.nasa.gov/pix/ven0aaa2.tif
	GLboolean error = load_targa("Jupiter.tga", width, height, format, type, pixels);
	...
	error = load_targa("ziemia.tga", width, height, format, type, pixels);
	...
	error = load_targa("mer0muu2.tga", width, height, format, type, pixels);
