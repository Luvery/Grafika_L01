...
void GenerateTextures()
{
	...
	// wczytanie tekstury silver-birch-tree-p40-745_image_edited.tga
	error = load_targa("silver-birch-tree-p40-745_image_edited.tga", width, height, format, type, pixels);

	// błąd odczytu pliku
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku silver-birch-tree-p40-745_image_edited.tga");
		exit(0);
	}
