...
std::array<GLfloat, 3 * (14 + 2)> vertices;
std::array<int, (14 + 1) * 2 * 3> triangles;
...
void BuildPyramid()
{
	vertices[3 * 14 + 0] = 0.0f;
	vertices[3 * 14 + 1] = 0.0f;
	vertices[3 * 14 + 2] = 0.0f;
	vertices[3 * (14 + 1) + 0] = 0.0f;
	vertices[3 * (14 + 1) + 1] = 0.0f;
	vertices[3 * (14 + 1) + 2] = 1.0f;

	// podstawa
	for (int i = 0; i < 14; ++i)
	{
		const GLfloat x = 0.5f * std::sin(2.0f * 3.1415f * ((GLfloat)i / 14));
		const GLfloat y = 0.5f * std::cos(2.0f * 3.1415f * ((GLfloat)i / 14));
	...
	{
		triangles[3 * i + 0] = 14;
		triangles[3 * i + 1] = i % 14;
		triangles[3 * i + 2] = (i + 1) % 14;

		triangles[3 * (i + 14 + 1) + 0] = (i + 1) % 14;
		triangles[3 * (i + 14 + 1) + 1] = i % 14;
		triangles[3 * (i + 14 + 1) + 2] = 14 + 1;
	}
}
